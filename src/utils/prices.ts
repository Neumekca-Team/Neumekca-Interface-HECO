...
import { ChainId, CurrencyAmount, Fraction, JSBI, Percent, TokenAmount, Trade } from '@neumekca/neumekca-sdk'
...
export function formatExecutionPrice(trade?: Trade, inverted?: boolean, chainId: ChainId = ChainId.HT_MAINNET): string {
  if (!trade) {
    return ''
  }
